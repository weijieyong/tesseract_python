...
safe_joint_positions = np.zeros(6)
viewer.update_joint_positions(joint_names, safe_joint_positions)
t_env.setState(joint_names, safe_joint_positions)

# DEBUG print joint limits
print("Joint limits:")
for jn in joint_names:
    lim = t_env.getJointLimits(jn)
    print(f"{jn}: lower={lim.lower}, upper={lim.upper}, velocity={lim.velocity}, effort={lim.effort}")
